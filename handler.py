# This program sobre linux in Container!
...
def kmz_converter(fileToconverter):
    # open the input KMZ file
    kmz_file = fileToconverter  #str(sys.argv[1])
...
def open_kmz(kmz_file):
    driver = gdal.GetDriverByName('LIBKML')
    data_source= driver.Open(kmz_file, gdalconst.GA_ReadOnly)

    if data_source is None:
        print("Failed to open file KKKKKKKKK.")
        #exit()
...
if __name__ == '__main__':
    gdal.SetConfigOption("GDAL_DISABLED_READDIR_ON_OPEN","YES")
